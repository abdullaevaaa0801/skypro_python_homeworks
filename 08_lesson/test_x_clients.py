...
def test_add_employer(get_token):
    ...
    body_employer = {
        ...
        'middleName': 'Alina',
        'companyId': comp_id,
        'email': 'miladriss@gmail.com',
        'url': 'string',
        'phone': '+79819649240',
        'birthdate': '1997-01-08T17:57:37.050Z',
        'isActive': True
    }
...
def test_get_employer():
    ...
    # Проверяем обязательное поле "ID company"в запросе списка на получение работников без указания "ID company"
